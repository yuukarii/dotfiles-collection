...
- Configure
    ...
    - Set up timezone.
    - Localization.
    - Network configuration. (Install `networkmanager`).
...
```bash
yay -Syu zsh zsh-autosuggestions zsh-syntax-highlighting zsh-history-substring-search
chsh -l
...
Automatic by `powertop.service` in hardware folder
